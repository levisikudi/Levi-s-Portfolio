        ...
        <div className="container ">
            ...
            <div className="collapse navbar-collapse justify-content-end" id="expandation">
                <ul className="navbar-nav navbar-nav-scroll">
                    ...
                    <li className="nav-item mx-4"><a href="https://drive.google.com/file/d/1wqo2fhB6IZUurzDOSLysO8jajxIRweZq/view?usp=sharing" target='#' className="nav-link">Resume</a></li>
                </ul> 
            </div>       
        </div>
    </nav>
